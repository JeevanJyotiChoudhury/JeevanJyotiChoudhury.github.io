...
import { GitHub, Linkedin, Mail, MapPin, Phone } from "react-feather";
...
export default function Contact() {
  ...
  return (
    <div id="contact" className="services__section">
      <section id="contact__section" style={{ overflow: "unset" }}>
        <div
        ...
        >
          <div className="services__section__content__left">
            ...
            <div
              className="services__section__content__left__entry"
              id="contact-phone"
            >
              <div className="services__section__content__left__entry__icon">
            ...
            >
              ...
              <div className="services__section__content__left__entry__content">
                <a
                  ...
                  className="social__number__text"
                  target="_blank"
                >
                  GitHub
                </a>
